...
- Drag task to another column: `Todo → In Progress → Done`
- Release to drop
...
### 6. Error Handling
If an operation fails or a validation rule is not met:
An error message is displayed and no changes are applied. System remains stable
